/*
 * build-data.mjs — the lit-data-nature data pipeline (a lit satellite data shard).
 * ===========================================================================
 * This repo is a SATELLITE DATA SHARD for stouras.com/lit/ ("The Lit"):
 * the Nature-portfolio journals (Nature, Nature Human Behaviour, Nature Communications), FILTERED to papers on GenAI/LLMs, innovation and the science of science — NOT the journals' full catalogues.
 *
...
async function main() {
  ...
  const meta = {
    ...
    source: 'OpenAlex topic/search scope + Crossref by-DOI harvest (Nature portfolio; GenAI/LLM, innovation and science-of-science papers only)',
  };
